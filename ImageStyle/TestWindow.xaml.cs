...
namespace ImageStyle
{
    ...
    public partial class TestWindow : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            backGroundOverlay.BackgroundBrush = new GeoSolidBrush(GeoColors.Blue);
            ...
            TextStyle textStyle = new TextStyle("name", new GeoFont("Arial", 10), new GeoSolidBrush(GeoColors.Maroon));
        ...
        private void wpfMap1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            PointShape pointShape = MapUtil.ToWorldCoordinate(wpfMap1.CurrentExtent, screenPointF, (float)wpfMap1.Width, (float)wpfMap1.Height);
